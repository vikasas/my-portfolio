...
const Helper = () =>{
    return(
        <div className="">
        <div className="w-full h-[70vh] sm:h-screen lg:h-screen bg-container flex justify-center items-center">
            <div className="w-3/4 h-4/5 p-6 lg:p-2 lg:w-3/4  lg:h-1/2 md:p-2 md:w-3/4  md:h-1/2 text-center">
